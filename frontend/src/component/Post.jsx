...
export const Post = ({ _id, title, summary, cover, createdAt, author }) => {
  ...
  return (
    <Link
      key={_id}
      to={`/post/${_id}`}
      className="group flex flex-col sm:flex-row bg-soft-white hover:bg-[#F2F0F9] border border-light-lavender rounded-lg overflow-hidden shadow-md transition duration-300 w-full sm:max-w-3xl h-64 sm:h-auto"
    >
      {/* Image Section */}
      ...
      <div className="flex-grow p-4 md:p-6 flex flex-col justify-between overflow-hidden h-64">
