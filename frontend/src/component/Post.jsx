...
export const Post = ({ _id, title, summary, cover, createdAt, author }) => {
  ...
  return (
    <Link 
      key={_id} 
      to={`/post/${_id}`}
      className="group flex bg-soft-white hover:bg-[#F2F0F9] border border-light-lavender rounded-lg overflow-hidden shadow-md transition duration-300 w-full sm:max-w-4xl h-auto sm:h-[600px]" 
    >
      {/* Image Section */}
