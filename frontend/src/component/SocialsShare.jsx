...
export const SocialsShare = ({ url }) => {
    ...
    return (
        <div className='flex space-x-3 items-center py-2 relative'> 
            <div className='absolute top-[-7px] left-[11.5rem] flex items-center'> 
                {copied && (
                <div className='text-deep-teal text-xs'>Copied!</div>
                )}
            </div>
            ...
            <button onClick={copyToClipboard}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 lg:size-8">
