  ...
  return (
    ...
    >
      <div className="flex flex-col max-w-md mx-auto lg:py-8 sm:py-20 text-center text-wrap">
        <h1 className="sm:text-7xl lg:text-7xl font-bold font-playfair leading-tight mb-2">
          WELCOME TO
        </h1>
        <h1 className="sm:text-7xl lg:text-7xl font-light lg:mb-4 sm:mb-8 leading-tight">
          BLOGONOMY
        </h1>
