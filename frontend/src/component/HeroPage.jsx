...
HeroPage = () => {
  return (
    <section className="relative w-screen h-screen sm:min-h-screen bg-gradient-to-r from-pale-pink to-light-lavender text-chery-red flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="max-w-md mx-auto py-8 sm:py-20 text-center">
        <h1 className="text-4xl md:text-6xl lg:text-5xl font-bold font-playfair leading-tight mb-2 text-deep-burgundy">
          WELCOME TO
        </h1>
        <h1 className="text-4xl md:text-6xl lg:text-5xl font-light mb-4 sm:mb-6 md:mb-8 leading-tight text-deep-burgundy">
          BLOGONOMY
        </h1>
