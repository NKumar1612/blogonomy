...
HeroPage = () => {
  return (
    <section className="w-screen h-screen md:h-full bg-gradient-to-r from-pale-pink to-light-lavender text-chery-red flex flex-col items-center justify-center px-4 sm:px-10">
      <div className="max-w-md mx-auto py-8 md:py-20 text-center">
        {/* Added max-w-md for content container and reduced padding */}
        ...
        <button className="bg-dark-olive-green text-soft-white font-barlow py-2 px-6 rounded-md hover:bg-darker-mint-green transition-colors duration-300 w-full md:w-auto">
          Start Exploring
        </button>
      </div>
    </section>
